...
import StopwatchContainer from '../screens/stopwatch/stopwatch.container';
...
import { addNewSubject, deleteSubject, addLearningTime } from '../data/action/subject';
...
const LerningPage = ({ route, navigation }) => {
  ...
  const { itemId, itemName, wantedTime } = route.params;
